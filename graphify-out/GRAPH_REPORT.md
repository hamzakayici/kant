...
## Corpus Check
- 149 files · ~711,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1535 nodes · 1661 edges · 137 communities (101 shown, 36 thin omitted)
...
Cohesion: 0.31
Nodes (17): assignUserRole(), createRole(), createUser(), deleteRole(), deleteUserAction(), getRoles(), toggleUserStatus(), updateRole() (+9 more)
...
Cohesion: 0.18
Nodes (11): Başlangıç Rehberi, Büyük dosya / Trello import hatası, Dosya Yükleme Dizini, Gereksinimler, NextAuth hatası, NPM Scriptleri, Prisma Client bulunamıyor, Prisma Komutları (+3 more)
...
Cohesion: 0.33
Nodes (6): 1. Projeyi klonlayın, 2. Bağımlılıkları yükleyin, 3. Ortam değişkenlerini ayarlayın, 4. Veritabanını hazırlayın, 5. Geliştirme sunucusunu başlatın, Kurulum
...
## Knowledge Gaps
- **1003 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+998 more)
